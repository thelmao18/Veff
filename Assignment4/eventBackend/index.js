...
function myAuthorizer (user, pw){
    const userMatches = basicAuth.safeCompare(user, 'admin')
    const passwordMatches = basicAuth.safeCompare(sha256(pw), '2bb80d537b1da3e38bd30361aa855686bde0eacd7162fef6a25fe97bf527a25b')
